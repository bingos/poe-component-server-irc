...
sub ircd_daemon_nick {
    ...
    $heap->{ircd}->yield( 'daemon_cmd_rkline', 'OperServ', '[bcd]obb.+@127\.0\.0\.1', 'Banhammer' );
...
sub client_disconnected {
  ...
  $heap->{ircd}->yield('daemon_cmd_unrkline','OperServ','[bcd]obb.+@127\.0\.0\.1');
  return;
}
