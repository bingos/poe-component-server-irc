...
my @responses = (
':1FU 364 7UPAAAAAA fake.server.irc groucho.server.irc :2 This is a fake server',
':1FU 364 7UPAAAAAA groucho.server.irc listen.server.irc :1 Open the door and come in!!!!!!',
':1FU 364 7UPAAAAAA harpo.server.irc listen.server.irc :1 Open the door and come in!!!!!!',
':1FU 364 7UPAAAAAA listen.server.irc listen.server.irc :0 Poco? POCO? POCO!',
':1FU 365 7UPAAAAAA * :End of /LINKS list.',
);
...
sub ircd_daemon_eob {
  ...
  if ( $heap->{eob} >= 3 ) {
    $poe_kernel->post( 'groucho', 'send_to_server', { prefix => '7UPAAAAAA', command => 'LINKS', params => [ '1FU', '*' ], colonify => 1 } );
  }
  return;
}
