...
'*** Notice -- Failed OPER attempt as moo by bobbins (~bobbins@listen.server.irc) - client certificate fingerprint mismatch',
...
sub ircd_listener_add {
    ...
    #F338C32EACDCF5D728AF19C62E2016A7EA8151361A011DFA3CD776196F06BD9D
    $heap->{ircd}->add_operator(
        {
            ...
            umode        => 'acy',
            ssl_required => 1,
            certfp       => '6B3F8703C0FB62B26DF8A12DB084ED11BB0636D7DDE48E0CA41483F06F1E0CDB4',
        }
    );
