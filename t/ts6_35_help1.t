...
':listen.server.irc 704 bobbins accept :ACCEPT [parameter]',
':listen.server.irc 705 bobbins accept :',
':listen.server.irc 705 bobbins accept :ACCEPT allows you to control who can send you a NOTICE or PRIVMSG',
':listen.server.irc 705 bobbins accept :while you have user mode +g enabled.',
':listen.server.irc 705 bobbins accept :',
':listen.server.irc 705 bobbins accept :For +g: /QUOTE ACCEPT <n!u@h>   -- Add a permitted mask',
':listen.server.irc 705 bobbins accept :        /QUOTE ACCEPT -<n!u@h>  -- Remove a permitted mask',
':listen.server.irc 705 bobbins accept :        /QUOTE ACCEPT *         -- List the present permitted masks',
':listen.server.irc 705 bobbins accept :        /QUOTE ACCEPT           -- List the present permitted masks',
':listen.server.irc 706 bobbins accept :End of /HELP.',
);
...
sub client_input {
  ...
  if ( $cmd eq 'MODE' && $params->[0] !~ m!^#! ) {
    ...
    $poe_kernel->post( $sender, 'send_to_server', { command => 'HELP', params => [ 'rubbish' ], colonify => 0 } );
