...
sub harpo_connected {
  ...
  $kernel->post( $sender, 'send_to_server', { prefix => '9T9', command => 'UID', params => [ 'bobbins', '1', $uidts, '+i', '~pobbins', 'bobbins.irc.not', '192.168.1.40', '9T9AAAAAB', '0', 'bobbins along' ], colonify => 1 } );
